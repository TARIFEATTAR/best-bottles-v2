...
export const CartDrawer: React.FC<CartDrawerProps> = ({
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div
                className={`fixed top-0 right-0 h-full w-full md:w-[500px] bg-[#F9F8F6] dark:bg-[#161616] shadow-2xl z-[100] transform transition-transform duration-500 cubic-bezier(0.16, 1, 0.3, 1) flex flex-col border-l border-gray-200 dark:border-gray-800 ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    {cartItems.length === 0 ? (
                        ...
                        cartItems.map((item, idx) => {
                            ...
                            const variantName = product.variant || (product.color && product.color !== 'All' ? product.color : null);
