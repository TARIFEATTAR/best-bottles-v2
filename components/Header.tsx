                ...
                <div className="max-w-[1800px] mx-auto">
                    ...
                    <div className="flex items-center justify-between px-6 py-5 gap-4 md:gap-8">
                        ...
                        <div className="hidden md:flex flex-1 max-w-2xl relative mx-auto items-center gap-4">
                            ...
                            {/* Talk With Grace — opens chat widget */}
                            <button
                                onClick={() => {
                                    onGraceClick?.();
                                }}
                                className="flex items-center gap-2 px-5 py-3 rounded-full transition-all duration-300 shadow-sm border bg-white dark:bg-[#1D1D1F] text-[#C5A065] border-[#C5A065]/30 hover:border-[#C5A065] hover:bg-[#fcfbf9] dark:hover:bg-[#252528]"
                                title="Talk to Grace"
                            >
                        ...
                        <>
                            ...
                            >
                                ...
                                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                    ...
                                    {/* Talk With Grace */}
                                    <button
                                        onClick={() => { toggleMobileMenu(); onGraceClick?.(); }}
                                        className="w-full bg-[#C5A065]/10 border border-[#C5A065]/30 text-[#C5A065] py-4 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2 shrink-0 hover:bg-[#C5A065]/20 transition-colors"
                                    >
