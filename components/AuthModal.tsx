...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onSignUpClick }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="relative bg-white dark:bg-[#1E1E1E] w-full max-w-[440px] p-10 md:p-12 shadow-2xl rounded-sm transform transition-all duration-500 scale-100 opacity-100 animate-[fadeUp_0.3s_ease-out]">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
                ...
                <div className="relative">
                    <input 
                        type="email" 
                        className="w-full border border-gray-300 dark:border-gray-600 rounded-md px-4 py-3 text-[#1D1D1F] dark:text-white dark:bg-black/20 focus:ring-1 focus:ring-gray-400 focus:border-gray-400 outline-none transition-all"
                    />
                </div>
            </div>
        ...
        <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-[#1E1E1E] text-gray-500">or</span>
            </div>
        </div>

        {/* Social Options */}
        <div className="space-y-3">
            <button className="w-full border border-gray-300 dark:border-gray-600 rounded-md py-3 flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                {/* Google Icon SVG */}
            ...
            <button className="w-full border border-gray-300 dark:border-gray-600 rounded-md py-3 flex items-center justify-center gap-3 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                {/* Apple Icon SVG */}
