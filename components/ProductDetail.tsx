                 ...
                 <div className="flex gap-3">
                     ...
                     <button 
                        ...
                        className={`flex-1 md:flex-none px-4 py-4 md:py-3 border border-gray-300 dark:border-gray-600 rounded text-sm font-bold uppercase tracking-widest flex items-center justify-center gap-2 transition-colors ${
                            isSaved ? 'bg-pink-50 border-pink-200 text-pink-600 dark:bg-pink-900/20 dark:text-pink-400' : 'bg-white dark:bg-transparent text-[#1e1e4b] dark:text-white hover:bg-gray-50'
                        }`}
                     >
                     ...
                     {/* Main Add to Cart */}
                     <button 
                        onClick={() => onAddToCart?.(PRODUCT, orderQty)}
