  ...
  return (
    <>
      ...
      <button
        ...
        className={`hidden md:flex fixed bottom-10 right-0 z-[80] bg-[#1D1D1F]/80 backdrop-blur-md border-l border-t border-b border-white/10 text-white py-6 px-3 rounded-l-xl shadow-[0_4px_20px_rgba(0,0,0,0.2)] flex-col items-center gap-4 transition-transform duration-300 hover:bg-[#C5A065] hover:text-[#1D1D1F] group ${isOpen ? 'translate-x-[120%]' : 'translate-x-0'
          }`}
