...
const MidnightNoirPage = () => {
    ...
    const product = {
        ...
        rating: 4.9,
        reviews: 234,
        description: 'A sophisticated black glass bottle that embodies modern luxury. The Midnight Noir features a sleek matte finish with subtle metallic accents, perfect for premium spirits and exclusive collections.',
        images: [
            '/images/midnight-noir-1.jpg',
            '/images/midnight-noir-2.jpg',
            '/images/midnight-noir-3.jpg',
            '/images/midnight-noir-4.jpg'
        ],
        features: [
            'Premium matte black glass',
    ...
    const handleAddToCart = () => {
        console.log(`Added ${quantity} Midnight Noir to cart`);
...
export default MidnightNoirPage;
